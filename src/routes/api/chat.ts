...
* ALWAYS USE THE DAD JOKE TOOL BEFORE TELLING A DAD JOKE. When you call it, set the \`searchTerm\` to 
  a word related to the user’s request. Try a few different search terms until you find a joke that is 
